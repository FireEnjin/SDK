...
var AuthService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, getIdTokenResult((_a = this.service) === null || _a === void 0 ? void 0 : _a.currentUser)];
                    case 1:
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getIdToken(this.service.currentUser)];
                    case 1:
                        _b = _c.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    AuthService.prototype.onEmailLink = function (link) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!isSignInWithEmailLink(this.service, link)) return [3 /*break*/, 2];
                        email = window.localStorage.getItem("emailForSignIn");
                        if (!email) {
                            email = window.prompt("Please provide your email for confirmation");
                        }
                        return [4 /*yield*/, signInWithEmailLink(this.service, email, link)];
                    case 1:
                        authUser = _a.sent();
    ...
    AuthService.prototype.onAuthChanged = function (callback) {
        var _this = this;
        onAuthStateChanged(this.service, function (session) { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b, _c;
            var _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getIdToken((_d = this.service) === null || _d === void 0 ? void 0 : _d.currentUser, true)];
                    case 1:
    ...
    AuthService.prototype.withEmail = function (email, password) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                signInWithEmailAndPassword(_this.service, email, password)
                    .then(function (user) {
    ...
    AuthService.prototype.updateEmail = function (newEmail, actionOptions) {
        ...
        return new Promise(function (resolve, reject) {
            var _a;
            try {
                updateEmail((_a = _this.service) === null || _a === void 0 ? void 0 : _a.currentUser, newEmail)
                    .then(function (user) {
                    resolve({ data: { user: user } });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, this.withCredential(FacebookAuthProvider.credential(result.authResponse.accessToken))];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        console.log(error_3);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/, this.withCredential(GoogleAuthProvider.credential(result.idToken))];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, this.withCredential(TwitterAuthProvider.credential(result.token, result.secret))];
                }
            });
        });
    };
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    return [4 /*yield*/, signInWithRedirect(this.service, provider)];
                                case 3:
                                    _a.sent();
                                    return [3 /*break*/, 6];
                                case 4: return [4 /*yield*/, signInWithPopup(this.service, provider)];
                                case 5:
                                    _a.sent();
                                    _a.label = 6;
                                case 6:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, reauthenticateWithCredential(this.service.currentUser, credential)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, updatePassword(this.service.currentUser, newPassword)];
                }
            });
        });
    };
